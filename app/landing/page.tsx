      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
        <div className="relative bg-navy text-white px-6 sm:px-12 pt-8 pb-16 lg:pb-24 flex flex-col">
          ...
          <h1 className="font-display text-4xl sm:text-5xl font-bold leading-[1.1] mb-5">
            The FUPRE campus ride app where drivers <span className="text-gold">compete</span> for your fare.
          </h1>
          <p className="text-white/60 text-lg mb-8 max-w-md">
            Built for students and staff at the Federal University of Petroleum Resources, Effurun. You request. Drivers bid. You pick the best campus ride for you.
          </p>
          <Link href="/request-ride">
            <Button size="lg" className="w-fit mb-4">
              Request a FUPRE Ride →
            </Button>
          </Link>
        ...
        <div className="relative bg-bg min-h-[420px] lg:min-h-0 flex items-center justify-center overflow-hidden">
          <div className="relative w-full h-full">
            <Image src="/images/landing-hero.svg" alt="BidRide car on the road" fill className="object-cover" />
          </div>
      ...
      <section className="px-6 sm:px-12 py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto">
          {steps.map((s) => (
            ...
            <p className="text-center text-sm text-navy/40 mt-16 mb-8">Starting with safe, reliable rides around FUPRE Effurun</p>
